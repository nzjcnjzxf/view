...
import {canvas, context, canvasWidth, canvasHeight} from './canvas'
...
class Game {
  ...
  bindTouchAction () {
    ...
    const planeMinX = 0
    const planeMinY = 0
    const planeMaxX = canvasWidth - opts.planeSize.width
    const palneMaxY = canvasHeight - opts.planeSize.height
    const self = this
