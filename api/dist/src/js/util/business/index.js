var Common = require('util/business/common.js')
var Oral = require('util/business/oral.js')
var Person = require('util/business/person.js')
var Role = require('util/business/role.js')
module.exports = (function ($) {
    ...
    /**口语名词新增编辑时显示的全局num */
    var oralAddNum = 1;
    var renderTable = Common.renderTable
    var clickButton = Common.clickButton
    var deleteTips = Common.deleteTips
    var myAlert = Common.myAlert
    var myTrim = Common.myTrim
    var createPage = Common.createPage
    var selectAddEvent = Common.selectAddEvent
    var getCenterInfo = Common.getCenterInfo
    /**---------------------------角色权限管理 start----------------------————-------------- */
    ...
    return {
        init: init,
        navContentChange: Common.navContentChange,
